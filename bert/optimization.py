...
def create_optimizer_multitask(loss, bert_lr=1e-4, others_lr=1e-3):
    with tf.variable_scope('opt'):
        ...
        opt1 = tf.train.AdamOptimizer(bert_lr)
        opt2 = tf.train.AdamOptimizer(others_lr)
    ...
    train_op = (train_op_bert, train_op_other)
    return train_op
