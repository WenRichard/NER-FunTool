...
flags.DEFINE_string(
    "export_dir", "D:/Expriment/model_output/ner_tool/bert_wol/single_task/clue_ner/exported_model/1",
...
def main(_):
  ...
  if FLAGS.do_export:
      estimator.export_savedmodel(FLAGS.export_dir, serving_input_receiver_fn,
